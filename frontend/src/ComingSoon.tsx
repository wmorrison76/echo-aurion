...
export default function ComingSoon({ title, eyebrow, endpoints, doctrineNote }: ComingSoonProps) {
  ...
  return (
    <div className="app-shell">
      ...
      <div className="drilldown" data-testid="coming-soon-page">
        ...
        >
          <div style={{ fontFamily: "Fraunces, serif", fontStyle: "italic", fontSize: 18, marginBottom: 12 }}>
          ...
          this missing-data state surfaces here as a first-class fact — not a 404, not a
          generic placeholder.
          {doctrineNote && (
