...
const STORAGE_KEY = "luccca.guided_tour.seen.v1";
...
const STEPS: Step[] = [
  ...
  {
    selector: '[data-testid="outlet-p66demo-galley"]',
    title: "The Galley · 47.4% eligible capture",
    body: "Each outlet has a multi-horizon Monte Carlo forecast and active learning loop. Tap to open the deep-dive.",
    placement: "top",
  },
  {
    selector: '[data-testid="tile-forecast-21"]',
...
export default function GuidedTour() {
  ...
  useEffect(() => {
    // Wait for the dashboard to mount before the tour kicks in
  ...
  return (
    <>
      {/* Dim overlay with a punched-out highlight */}
      <div
