...
const ICINGS = ["Buttercream", "Cream Cheese", "Ganache", "Whipped Cream", "Fondant", "Royal Icing"];
...
export default function IntakePrescreen({ onComplete, onCancel }: IntakePrescreonProps) {
  ...
  const handleAllergiesChange = (value: string) => {
    if (value.toLowerCase() === "none" || value.toLowerCase() === "no allergies" || !value.trim()) {
  ...
  const sections = [
    ...
    <div key="step0" className="space-y-5">
      <div className="bg-gradient-to-br from-cyan-50 to-blue-50 p-4 rounded-lg border border-cyan-200">
        <h3 className="font-semibold text-lg text-gray-800 mb-4">📅 Event Details</h3>
        
        <div className="space-y-4">
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Occasion *</label>
            <Input
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-sm font-medium text-gray-700 block mb-2">Event Date *</label>
              <Input
                type="date"
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 block mb-2">Event Time</label>
              <Input
                type="time"
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Guest Count *</label>
            <Input
              type="number"
              min="1"
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Venue/Location Details</label>
            <Input
    ...
    <div key="step1" className="space-y-5">
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-4 rounded-lg border border-amber-200">
        <h3 className="font-semibold text-lg text-gray-800 mb-4">🍰 Cake Preferences</h3>

        <div className="space-y-4">
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Cake Type *</label>
            <select
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Base Flavor *</label>
            <select
              value={answers.flavors[0] || ""}
              onChange={(e) => handleChange("flavors", e.target.value ? [e.target.value] : [])}
              className="w-full border border-gray-300 rounded-lg p-2.5 bg-white"
            >
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Icing/Frosting Type *</label>
            <select
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Filling</label>
            <select
              value={answers.fillings[0] || ""}
              onChange={(e) => handleChange("fillings", e.target.value ? [e.target.value] : [])}
              className="w-full border border-gray-300 rounded-lg p-2.5 bg-white"
            >
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-3">Shape *</label>
            ...
            <div className="mt-3">
              <label className="text-xs font-medium text-gray-700 block mb-2">Or describe custom shape (e.g., "Mad Hatter", "Heart-shaped")</label>
              <Input
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Number of Tiers *</label>
            <Input
              type="number"
              min="1"
              max="5"
              value={answers.tierCount}
              onChange={(e) => handleChange("tierCount", Number(e.target.value))}
              className="border-gray-300"
            />
          </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleChange("outdoorIcing", checked)}
              id="outdoor"
            />
            <label htmlFor="outdoor" className="text-sm font-medium text-gray-700 cursor-pointer">
    ...
    <div key="step2" className="space-y-5">
      <div className="bg-gradient-to-br from-rose-50 to-pink-50 p-4 rounded-lg border border-rose-200">
        <h3 className="font-semibold text-lg text-gray-800 mb-4">⚠️ Dietary Needs & Allergies</h3>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="mb-3 flex items-center gap-3">
              <Checkbox
                ...
                id="noAllergies"
              />
              <label htmlFor="noAllergies" className="text-sm font-medium text-gray-700 cursor-pointer">
                No allergies
              </label>
            </div>
            {!hasNoAllergies && (
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Dietary Restrictions/Preferences</label>
            <Input
              value={answers.dietaryPreferences.join(", ")}
              onChange={(e) => handleChange("dietaryPreferences", e.target.value.split(",").map((a) => a.trim()).filter((a) => a))}
          ...
          <div className="flex items-center gap-3">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleChange("tastingRequested", checked)}
              id="tasting"
            />
            <label htmlFor="tasting" className="text-sm font-medium text-gray-700 cursor-pointer">
              Client wants a tasting session
            </label>
          </div>

          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Design Complexity</label>
            <div className="flex gap-3">
              {["simple", "intricate"].map((complexity) => (
                <button
                  key={complexity}
                  onClick={() => handleChange("designComplexity", complexity as any)}
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => handleChange("specialDietNeeds", e.target.value.split(",").map((a) => a.trim()).filter((a) => a))}
    ...
    <div key="step3" className="space-y-5">
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
        <h3 className="font-semibold text-lg text-gray-800 mb-4">🚚 Delivery & Order Terms</h3>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleChange("deliveryFeeApproved", checked)}
              id="deliveryFee"
            />
            <label htmlFor="deliveryFee" className="text-sm font-medium text-gray-700 cursor-pointer">
          ...
          <div className="flex items-center gap-3">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleChange("depositConfirmed", checked)}
              id="deposit"
            />
            <label htmlFor="deposit" className="text-sm font-medium text-gray-700 cursor-pointer">
              Deposit confirmed
            </label>
          </div>

          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">BEO/REO Number (for events)</label>
            <Input
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 block mb-2">Venue Restrictions/Notes</label>
            <Input
    ...
    <div key="step4" className="space-y-4">
      <h3 className="font-semibold text-lg text-gray-800 mb-4">✅ Review Summary</h3>
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-lg border border-blue-200 space-y-3">
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">{answers.customShape || answers.tiersShape}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">{answers.flavors[0] || "Not selected"}</p>
          </div>
          <div>
            <span className="text-gray-600">Icing:</span>
            <p className="font-semibold text-gray-900">{answers.cakeIcing || "Not selected"}</p>
          </div>
          <div>
          ...
          <div className="col-span-2">
            ...
            <p className="font-semibold text-gray-900">{answers.allergies.length > 0 ? answers.allergies.join(", ") : "None"}</p>
          </div>
          <div className="col-span-2">
            <span className="text-gray-600">Delivery:</span>
            <p className="font-semibold text-gray-900">{answers.deliveryType}</p>
          </div>
        </div>
      </div>
      <div className="text-xs text-gray-500 mt-4 bg-gray-50 p-3 rounded">
        💾 Your intake data is auto-saved locally. You can continue editing and it will be preserved.
      </div>
    </div>,
  ];
      ...
      <CardContent className="space-y-6 p-6">
          ...
          {[0, 1, 2, 3, 4].map((s) => (
            <div
              ...
              className={`h-2 flex-1 rounded-full transition-all ${
                s <= step ? "bg-gradient-to-r from-cyan-500 to-blue-500" : "bg-gray-200"
              }`}
            />
          ))}
        </div>
        ...
        <div className="flex justify-between gap-3 pt-6 border-t">
          ...
          {step === 4 ? (
            ...
            <Button onClick={handleNext} className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white ml-auto">
              Next →
            </Button>
          )}
        </div>
