...
import * as ToastPrimitives from"@radix-ui/react-toast"; export const ToastProvider = ToastPrimitives.Provider;
export const ToastViewport = (props: React.ComponentProps<typeof ToastPrimitives.Viewport>) => ( <ToastPrimitives.Viewport {...props} />
...
export const ToastClose = ToastPrimitives.Close; // Re-export types if TS wants them elsewhere
