/** * EchoLayoutPanel * Enhanced main panel wrapper for the immersive 3D dining layout designer * Includes: HUD stack, numeric wiring, chair instancing, Presenter lock, Builder.io SaaS UX */ import React, {
  useState,
  useEffect,
  useCallback,
  useMemo,
