...
export {
  default as CakeBuilderModule,
  type CakeBuilderModuleProps,
  CakeBuilderTab,
} from "./CakeBuilderModule";
...
export { default } from "./CakeBuilderModule";
...
export const CAKE_BUILDER_MODULE = {
  ...
  description:
    "Design and price custom cakes with 3D preview, intake forms, and recipe management",
  icon: "🍰",
  version: "1.0.0",
};
