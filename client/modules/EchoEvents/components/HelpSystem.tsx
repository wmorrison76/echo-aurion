...
const quickTips = [
  {
    ...
    description:
      "Instantly search across all data - contacts, events, menus, and actions",
    icon: Search,
  },
  {
    title: "Event Templates",
    description:
      "Use professional templates to jumpstart corporate events, weddings, and galas",
    icon: FileText,
  },
  {
    title: "AI Sales Suggestions",
    description:
      "Let AI analyze your events and suggest revenue-boosting enhancements",
    icon: Star,
  },
  {
    title: "EchoHelp Tutorials",
    description:
      "Interactive step-by-step guidance with visual walkthroughs for any feature",
    icon: HelpCircle,
  },
  {
    title: "Keyboard Shortcuts",
    description:
      "Navigate faster with shortcuts - Alt+1-6 for sidebar, Ctrl+B to toggle",
    icon: Keyboard,
  },
  {
    title: "Echo Monitoring",
    description:
      "Echo AI continuously monitors system health and security for you",
    icon: Shield,
  },
  {
    title: "Smart Preferences",
    description:
      "Customize themes, shortcuts, and workflows to match your style",
    icon: Settings,
  },
  {
    title: "Auto-Save",
    description:
      "Your work and preferences are automatically saved every 30 seconds",
    icon: CheckCircle,
  },
];
      ...
      <DialogContent className="glass-panel max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <DialogHeader>
          ...
          <DialogTitle className="text-2xl flex items-center">
            {" "}
            <Book className="h-6 w-6 mr-2" /> Help & Documentation{" "}
          </DialogTitle>{" "}
          <DialogDescription>
            {" "}
            Find answers, learn features, and get the most out of your
            hospitality CRM{" "}
          </DialogDescription>{" "}
        </DialogHeader>{" "}
          ...
          <TabsContent value="shortcuts" className="space-y-4 mt-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="font-medium text-blue-700 dark:text-primary">
                  Pro Tip
                </span>{" "}
              </div>{" "}
              <p className="text-sm text-primary dark:text-blue-200">
                ...
                anywhere in the application to quickly access keyboard
                shortcuts.{" "}
              </p>{" "}
            </div>{" "}
          </TabsContent>{" "}
