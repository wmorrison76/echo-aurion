...
const sampleOutlets: Outlet[] = [
  ...
  },
  {
    ...
    pricing: {
      ...
      equipmentRental: { "Dessert Station": 40, "Coffee Service": 30 },
    },
  },
];
const sampleEventSpaces: EventSpace[] = [
  {
    ...
    dimensions: { length: 60, width: 40, height: 14, squareFeet: 2400 },
  ...
  },
  {
    ...
    dimensions: { length: 40, width: 30, height: 12, squareFeet: 1200 },
      ...
      const progressInterval = setInterval(() => {
        setCurrentUpload((prev) => {
          ...
          if (newProgress >= 25 && prev.processingStage === "ocr") {
            ...
            newProgress >= 90 &&
            prev.processingStage === "validation"
          ) {
            newStage = "complete";
            newStatus = "completed";
            newProgress = 100;
                  ...
                  items: [
                    {
                      ...
                      name: "Grilled Salmon",
                      description:
                        "Atlantic salmon with herb butter and seasonal vegetables",
                      price: 32,
  ...
  const handleSaveMenu = () => {
    if (parsedMenu && onMenuCreated) {
      const completeMenu: Menu = {
        ...
        outlet: selectedMenuOutlet,
        effectiveDate:
          parsedMenu.effectiveDate || new Date().toISOString().split("T")[0],
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogTrigger asChild>
        ...
        <Button className="apple-button">
          {" "}
          <Upload className="h-4 w-4 mr-2" /> Parse Menu{" "}
        </Button>{" "}
      </DialogTrigger>{" "}
      <DialogContent className="glass-panel max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {" "}
            Upload and parse catering/banquet menus, manage outlets and event
            spaces{" "}
          </DialogDescription>{" "}
        </DialogHeader>{" "}
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="review" disabled={!parsedMenu}>
              Review & Save
            </TabsTrigger>{" "}
          </TabsList>{" "}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Select
                      value={selectedMenuOutlet || "none"}
                      onValueChange={setSelectedMenuOutlet}
                    >
                      {" "}
                      <SelectTrigger>
                        {" "}
                  ...
                  <div>
                    ...
                    <Select
                      value={selectedMenuEventSpace || "none"}
                      onValueChange={setSelectedMenuEventSpace}
                    >
                      {" "}
                      <SelectTrigger>
                        {" "}
                      ...
                      <SelectContent>
                        ...
                        {eventSpaces
                          ?.filter(
                            (space) => space?.id && space?.name && space?.type,
                          )
                          .map((space) => (
                            <SelectItem key={space.id} value={space.id}>
                              ...
                              <div className="flex items-center">
                                {" "}
                                <MapPin className="h-4 w-4 mr-2" /> {space.name}{" "}
                                - {space.type}{" "}
                              </div>{" "}
                            </SelectItem>
                          )) || []}{" "}
                ...
                <Card key={outlet.id} className="glass-panel">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {" "}
                      {outlet.capabilities.serviceStyles
                        .slice(0, 3)
                        .map((style, index) => (
                          <Badge
                            key={index}
                ...
                <Card key={space.id} className="glass-panel">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="text-sm">
                      {" "}
                      <p className="text-muted-foreground mb-1">
                        Setup: {space.availability.setupTime}h | Breakdown:{" "}
                        {space.availability.breakdownTime}h
                      </p>{" "}
                    </div>{" "}
                    <div className="flex flex-wrap gap-1">
                      {" "}
            ...
            {parsedMenu && parsedMenu.sections && (
              <>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    {" "}
                    Review the extracted menu items below and make any necessary
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>
                          {outlets.find((o) => o.id === selectedMenuOutlet)
                            ?.name || "None"}
                        </span>{" "}
                      </div>{" "}
                      <div className="flex justify-between">
                          ...
                          <div className="space-y-3">
                            ...
                            {section.items
                              ...
                              .map((item, itemIndex) => (
                                <div
                                  key={item.id}
                                  className="flex items-start justify-between p-3 bg-muted/20 rounded-lg"
                                >
                                  {" "}
