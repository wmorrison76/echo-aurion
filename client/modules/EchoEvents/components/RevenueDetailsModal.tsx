      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden">
        ...
        <DialogHeader>
          ...
          <DialogTitle className="flex items-center space-x-2">
            ...
            <span>
              Revenue Analytics - {formatCurrency(revenueData.total)} YTD
            </span>{" "}
          </DialogTitle>{" "}
        </DialogHeader>{" "}
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="text-2xl font-bold">
                    {formatCurrency(revenueData.monthly.current)}
                  </div>{" "}
                  <div className="flex items-center space-x-1 text-xs mt-1">
                    {" "}
                    <span
                      className={getGrowthColor(revenueData.monthly.growth)}
                    >
                      {" "}
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="text-2xl font-bold text-green-600">
                    {" "}
                    {Math.round(
                      (revenueData.monthly.current /
                        revenueData.monthly.target) *
                        100,
                    )}
                    %{" "}
                  </div>{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Revenue vs target over the last 6 months
                  </CardDescription>{" "}
                </CardHeader>{" "}
                <CardContent>
                  {" "}
                  <div className="space-y-4">
                    ...
                    {revenueData.monthlyTrend.map((month, index) => (
                      ...
                      >
                        ...
                        <div
                          className={`text-sm ${month.revenue >= month.target ? "text-green-600" : "text-orange-600"}`}
                        >
                          {" "}
              ...
              <Card>
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Q1 2024 vs Q4 2023 performance
                  </CardDescription>{" "}
                </CardHeader>{" "}
                <CardContent>
                  {" "}
                        ...
                        <div className="space-y-2 mt-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {formatCurrency(
                                revenueData.quarterlyComparison.q4_2023.revenue,
                              )}
                            </span>{" "}
                          </div>{" "}
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {revenueData.quarterlyComparison.q4_2023.events}
                            </span>{" "}
                          </div>{" "}
                          <div className="flex justify-between">
                            {" "}
                            ...
                            <span className="font-medium">
                              {formatCurrency(
                                revenueData.quarterlyComparison.q4_2023.avgDeal,
                              )}
                            </span>{" "}
                          </div>{" "}
                        </div>{" "}
                      ...
                      <div>
                        ...
                        <div className="space-y-2 mt-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {formatCurrency(
                                revenueData.quarterlyComparison.q1_2024.revenue,
                              )}
                            </span>{" "}
                          </div>{" "}
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm">Events:</span>{" "}
                            <span className="font-medium">
                              {revenueData.quarterlyComparison.q1_2024.events}
                            </span>{" "}
                          </div>{" "}
                          <div className="flex justify-between">
                            {" "}
                            ...
                            <span className="font-medium">
                              {formatCurrency(
                                revenueData.quarterlyComparison.q1_2024.avgDeal,
                              )}
                            </span>{" "}
                          </div>{" "}
                        </div>{" "}
          ...
          <TabsContent value="breakdown" className="space-y-4">
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-1">
                        {" "}
                        <span
                          className={`text-sm ${getGrowthColor(data.growth)}`}
                        >
                          {" "}
                          {getGrowthIcon(data.growth)}{" "}
                        </span>{" "}
                        <span
                          className={`text-sm font-medium ${getGrowthColor(data.growth)}`}
                        >
                          {" "}
                          {data.growth > 0 ? "+" : ""}
                          {data.growth}%{" "}
            ...
            <Card>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  Detailed breakdown by event category
                </CardDescription>{" "}
              </CardHeader>{" "}
              <CardContent>
                {" "}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="font-medium">
                          {formatCurrency(
                            revenueData.breakdown.corporate.amount,
                          )}
                        </div>{" "}
                        <div className="text-sm text-muted-foreground">
                          {revenueData.breakdown.corporate.percentage}% of total
                        </div>{" "}
                      </div>{" "}
                    </div>{" "}
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="font-medium">
                          {formatCurrency(
                            revenueData.breakdown.weddings.amount,
                          )}
                        </div>{" "}
                        <div className="text-sm text-muted-foreground">
                          {revenueData.breakdown.weddings.percentage}% of total
                        </div>{" "}
                      </div>{" "}
                    </div>{" "}
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="font-medium">
                          {formatCurrency(
                            revenueData.breakdown.socialEvents.amount,
                          )}
                        </div>{" "}
                        <div className="text-sm text-muted-foreground">
                          {revenueData.breakdown.socialEvents.percentage}% of
                          total
                        </div>{" "}
                      </div>{" "}
                    </div>{" "}
          ...
          <TabsContent value="clients" className="space-y-4">
            ...
            <Card>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  Client performance and growth metrics
                </CardDescription>{" "}
              </CardHeader>{" "}
              <CardContent>
                {" "}
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {client.events} events this year
                            </p>{" "}
                          </div>{" "}
                        </div>{" "}
                        <div className="text-right">
