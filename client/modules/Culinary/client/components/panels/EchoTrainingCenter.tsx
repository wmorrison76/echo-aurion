...
export function EchoTrainingCenter() {
  ...
  const [mode, setMode] = useState<TrainingMode>("sequential");
    ...
    return (
      <div className="space-y-6">
        <div className="space-y-2">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-[#c8a97e] to-[#b8976c] bg-clip-text text-transparent">
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          <Button
            ...
            className="flex-1 h-12 text-lg font-semibold bg-gradient-to-r from-[#c8a97e] to-[#b8976c] hover:from-blue-700 hover:to-[#b8976c]"
          >
