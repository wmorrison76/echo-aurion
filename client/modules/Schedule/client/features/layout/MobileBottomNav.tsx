...
export default function MobileBottomNav({
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-30 border-t bg-background/90 backdrop-blur md:hidden"
    ...
    >
      ...
      <div className="container px-2 py-2 grid grid-cols-3 gap-2">
        ...
        <Button size="xs" variant="outline" onClick={onOpenDrawer}>
          <PanelRight className="mr-1" />
          Drawer
        </Button>{" "}
      </div>{" "}
    </div>
