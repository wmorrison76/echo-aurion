          ...
          <DialogContent>
            ...
            {it.key === "union" && (
              <div className="text-sm">
                {" "}
                <p>
                  Configure seniority bidding and overtime equalization
                  policies. Settings are saved locally and can be referenced by
                  scheduling engines.
                </p>{" "}
