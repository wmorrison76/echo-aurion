        ...
        {me && (
          <>
            ...
            <div className="border rounded-lg p-4 bg-gradient-to-br from-primary/10 to-primary/5">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="text-center">
                  {" "}
                  <div
                    className={`text-2xl font-bold ${scheduleMetrics.isOvertime ? "text-orange-600" : "text-green-600"}`}
                  >
                    {" "}
            ...
            <div className="flex gap-2 border-b bg-muted/30 rounded-lg overflow-hidden">
              {" "}
              {(["schedule", "prefs", "timeoff", "profile"] as const).map(
                (tab) => (
                  <button
                    key={tab}
                    onClick={() => setActiveTab(tab)}
                    className={`flex-1 py-2 px-2 text-xs font-medium transition-colors ${activeTab === tab ? "bg-primary text-primary-foreground" : "text-muted-foreground"}`}
                  >
                    {" "}
                    ...
                    <div className="flex gap-2 items-start">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-orange-800 mt-1">
                          ...
                          {scheduleMetrics.totalHours.toFixed(1)} hours this
                          week. Please acknowledge.{" "}
                        </div>{" "}
                        <Button
                          size="sm"
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="text-xs inline-flex items-center gap-2 mt-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setPrefs({ ...prefs, extraHours: e.target.checked })
                        }
                      />{" "}
