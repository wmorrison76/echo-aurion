...
export function toADP(data: WeeklyTotals) {
  return csv(baseRows(data));
}
export function toQuickBooks(data: WeeklyTotals) {
  return csv(baseRows(data));
}
export function toPaychex(data: WeeklyTotals) {
  return csv(baseRows(data));
}
export function toPaylocity(data: WeeklyTotals) {
  return csv(baseRows(data));
}
export function toGusto(data: WeeklyTotals) {
  return csv(baseRows(data));
}
export function toDayforce(data: WeeklyTotals) {
  return csv(baseRows(data));
}
export function toUKG(data: WeeklyTotals) {
  return csv(baseRows(data));
}
