...
// Avoid eager loading to prevent circular dependencies
const projectSources: Record<string, string> = {};

const HAS_WINDOW = typeof window !== "undefined";

export default function Board() {
  console.log("Board: Rendering board component");
...
function ProjectCard({
  ...
  return (
    <div className="flex h-full flex-col justify-between rounded-xl border border-border/60 bg-background/70 p-4 shadow-sm transition hover:border-border hover:shadow-md relative">
